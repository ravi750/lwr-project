...
originalDefinition$LWS, tagName$LWS) {
  ...
  }, _a$LWS.formAssociated = true, _a$LWS.observedAttributes = originalDefinition$LWS.observedAttributes ? shared$LWS.shallowCloneArray(originalDefinition$LWS.observedAttributes) : [], _a$LWS;
}
  ...
  return function distortionDocumentExecCommand$LWS({
    ...
    return [originalExecCommand$LWS, function execCommand$LWS(...args$LWS) {
      ...
      if (length$LWS >= 1) {
        ...
        if (length$LWS === 1 && loweredCommand$LWS === 'selectall' && this === sharedDom$LWS.rootDocument) {
  ...
  const distortionEntry$LWS = [originalAttachShadow$LWS, function attachShadow$LWS(...args$LWS) {
    ...
    if (args$LWS.length) {
      ...
      if (originalShadowRootInit$LWS !== null && originalShadowRootInit$LWS !== undefined) {
        ...
        const clonedShadowRootInit$LWS = shared$LWS.shallowCloneOptions(originalShadowRootInit$LWS);
        ...
        shared$LWS.ReflectSetPrototypeOf(clonedShadowRootInit$LWS, originalShadowRootInitProto$LWS);
