...
const HIGHEST_API_VERSION = 60 /* APIVersion.V60_248_SPRING_24 */;
const allVersions = [
...
function lwc(pluginOptions = {}) {
    ...
    return {
        ...
        transform(src, id) {
            ...
            const { code, map, warnings } = compiler.transformSync(src, filename, Object.assign({ name,
                namespace, outputConfig: { sourcemap }, stylesheetConfig,
                ...
                preserveHtmlComments, scopedStyles: scoped, disableSyntheticShadowSupport, apiVersion: apiVersionToUse }, ('enableStaticContentOptimization' in pluginOptions && {
